...
export default function ScootOff() {
  return (
    <section className="relative flex flex-col items-center justify-center gap-y-10 overflow-hidden bg-[#495567] px-6 py-[5.5rem] sm:py-[3.88rem] lg:flex-row lg:items-center lg:justify-between lg:px-16">
